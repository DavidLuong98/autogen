// Ask if we can delete this class since it's deprecated
...
//     public static IEnumerable<ChatMessage> ToOpenAIChatRequestMessage(this IAgent agent, IMessage message)
//     {
//         if (message is IMessage<ChatMessage> oaiMessage)
//         {
//             // short-circuit
...
//                 {
//                     var msg = new SystemChatMessage(textMessage.Content);
//
//                     return [msg];
//                 }
//                 else
//                 {
//                     var msg = new UserChatMessage(textMessage.Content);
//                     return [msg];
//                 }
//             }
...
//             {
//                 // multi-modal
//                 var msg = new UserChatMessage(ChatMessageContentPart.CreateImageMessageContentPart(new Uri(imageMessage.Url ?? imageMessage.BuildDataUri())));
//
//                 return [msg];
//             }
